...
class HorizontalCalendarAdapterDate extends RecyclerView.Adapter<HorizontalCalendarAdapterDate.MyViewHolder> {
    ...
    public HorizontalCalendarAdapterDate(ArrayList<HorizontalCalendarModel> list, Context mCtx) {
        this.list = list;
        this.mCtx = mCtx;
    }
