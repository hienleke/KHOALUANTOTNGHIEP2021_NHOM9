...
class HorizontalCalendarAdapterMonth extends RecyclerView.Adapter<HorizontalCalendarAdapterMonth.MyViewHolder> {
    ...
    public HorizontalCalendarAdapterMonth(ArrayList<HorizontalCalendarModel> list, Context mCtx) {
        this.list = list;
        this.mCtx = mCtx;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            month = view.findViewById(R.id.month_month);
            parent = view.findViewById(R.id.parent_month);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.horizontal_calendar_list_item_month, parent, false);
