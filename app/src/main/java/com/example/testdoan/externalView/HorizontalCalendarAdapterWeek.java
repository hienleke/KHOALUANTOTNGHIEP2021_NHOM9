...
class HorizontalCalendarAdapterWeek extends RecyclerView.Adapter<HorizontalCalendarAdapterWeek.MyViewHolder> {
    ...
    public HorizontalCalendarAdapterWeek(ArrayList<HorizontalCalendarModel> list, Context mCtx) {
        this.list = list;
        this.mCtx = mCtx;
    }
